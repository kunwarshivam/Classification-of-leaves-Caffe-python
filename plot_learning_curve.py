...
caffe_path = '/home/kunwar/deep-learning/caffe/'
...
#Plotting test accuracy and train accuracy
ax2 = ax1.twinx()
test_accuracy, = ax2.plot(test_log['#Iters'], test_log['TestAccuracy'], linewidth=2, color='blue')
#train_accuracy, = ax2.plot(train_log['#Iters'], train_log['TrainAccuracy'], linewidth=2, color='yellow')
